...
class Ui_AuthDialog(object):
    def setupUi(self, AuthDialog):
        ...
        AuthDialog.resize(400, 150)
        AuthDialog.setWindowFlags(Qt.CustomizeWindowHint)
        AuthDialog.setAutoFillBackground(False)
        AuthDialog.setStyleSheet("QDialog{background-color:white;}")

        self.retranslateUi(AuthDialog)
        QMetaObject.connectSlotsByName(AuthDialog)

        self.setupMainLayout(AuthDialog)
        self.setupDialogNav()
        self.setupFormArea()
        self.setupNavArea()
    ...
    def retranslateUi(self, AuthDialog):
        ...
        AuthDialog.setWindowTitle(_translate("AuthDialog", "管理員驗證"))
        AuthDialog.setWindowIcon(QIcon(SvgHelper.getQPixmapFromBytes(logoIcon, QSize(512, 512))))


    def setupMainLayout(self, AuthDialog):
        self.mainLayout = QVBoxLayout()
        self.mainLayout.setContentsMargins(0,0,0,0)
        AuthDialog.setLayout(self.mainLayout)
    ...
    def setupFormArea(self):
        ...
        passwordLabel.setText("請輸入管理員密碼：")
