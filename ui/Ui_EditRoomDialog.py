...
# Form implementation generated from reading ui file 'd:\桌面\TKUIofoCenterClient\uiFile\EditRoomDialog.ui'
#
...
class Ui_EditRoomDialog(object):
    def setupUi(self, EditRoomDialog):
        EditRoomDialog.setObjectName("EditRoomDialog")
        EditRoomDialog.setWindowFlags(Qt.CustomizeWindowHint)
        EditRoomDialog.resize(1000, 450)
        EditRoomDialog.setAutoFillBackground(False)
        EditRoomDialog.setStyleSheet("QDialog{background-color:white;}")

        self.retranslateUi(EditRoomDialog)
        QMetaObject.connectSlotsByName(EditRoomDialog)

        self.setupMainLayout(EditRoomDialog)
        self.setupDialogNav()
        self.setupCenterialArea()
        self.setupContentArea()
        self.setupNavArea()

    def retranslateUi(self, EditRoomDialog):
        _translate = QCoreApplication.translate
        EditRoomDialog.setWindowTitle(_translate("EditRoomDialog", "實習室編輯"))
        EditRoomDialog.setWindowIcon(QIcon(SvgHelper.getQPixmapFromBytes(logoIcon, QSize(512, 512))))


    def setupMainLayout(self, EditRoomDialog):
        self.mainLayout = QVBoxLayout()
        self.mainLayout.setContentsMargins(0,0,0,0)
        EditRoomDialog.setLayout(self.mainLayout)
    ...
    def setupContentArea(self):
        ...
        self.listArea.setHeaderLabels(["實習室名稱"])
