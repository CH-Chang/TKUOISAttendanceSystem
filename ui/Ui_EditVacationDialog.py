...
# Form implementation generated from reading ui file 'd:\桌面\TKUIofoCenterClient\uiFile\EditVacationDialog.ui'
#
...
class Ui_EditVacationDialog(object):
    def setupUi(self, EditVacationDialog):
        EditVacationDialog.setObjectName("EditVacationDialog")
        EditVacationDialog.setWindowFlags(Qt.CustomizeWindowHint)
        EditVacationDialog.resize(1000, 450)
        EditVacationDialog.setAutoFillBackground(False)
        EditVacationDialog.setStyleSheet("QDialog{background-color:white;}")

        self.retranslateUi(EditVacationDialog)
        QMetaObject.connectSlotsByName(EditVacationDialog)

        self.setupMainLayout(EditVacationDialog)
        self.setupDialogNav()
        self.setupCenterialArea()
        self.setupContentArea()
        self.setupNavArea()

    def retranslateUi(self, EditVacationDialog):
        _translate = QCoreApplication.translate
        EditVacationDialog.setWindowTitle(_translate("EditVacationDialog", "假日編輯"))
        EditVacationDialog.setWindowIcon(QIcon(SvgHelper.getQPixmapFromBytes(logoIcon, QSize(512, 512))))


    def setupMainLayout(self, EditVacationDialog):
        self.mainLayout = QVBoxLayout()
        self.mainLayout.setContentsMargins(0,0,0,0)
        EditVacationDialog.setLayout(self.mainLayout)
    ...
    def setupContentArea(self):
        ...
        self.listArea.setHeaderLabels(["假日名稱", "起始日期", "結束日期"])
