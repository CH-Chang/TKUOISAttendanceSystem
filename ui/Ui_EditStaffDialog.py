...
# Form implementation generated from reading ui file 'd:\桌面\TKUIofoCenterClient\uiFile\EditStaffDialog.ui'
#
...
class Ui_EditStaffDialog(object):
    def setupUi(self, EditStaffDialog):
        EditStaffDialog.setObjectName("EditStaffDialog")
        EditStaffDialog.setWindowFlags(Qt.CustomizeWindowHint)
        EditStaffDialog.resize(1000, 450)
        EditStaffDialog.setAutoFillBackground(False)
        EditStaffDialog.setStyleSheet("QDialog{background-color:white;}")

        self.retranslateUi(EditStaffDialog)
        QMetaObject.connectSlotsByName(EditStaffDialog)

        self.setupMainLayout(EditStaffDialog)
        self.setupDialogNav()
        self.setupCenterialArea()
        self.setupContentArea()
        self.setupNavArea()

    def retranslateUi(self, EditStaffDialog):
        _translate = QCoreApplication.translate
        EditStaffDialog.setWindowTitle(_translate("EditStaffDialog", "工讀生編輯"))
        EditStaffDialog.setWindowIcon(QIcon(SvgHelper.getQPixmapFromBytes(logoIcon, QSize(512, 512))))


    def setupMainLayout(self, EditStaffDialog):
        self.mainLayout = QVBoxLayout()
        self.mainLayout.setContentsMargins(0,0,0,0)
        EditStaffDialog.setLayout(self.mainLayout)
    ...
    def setupContentArea(self):
        ...
        self.listArea.setHeaderLabels(["工讀生編號", "工讀生學號", "工讀生姓名"])
