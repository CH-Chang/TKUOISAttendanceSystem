...
# Form implementation generated from reading ui file 'd:\桌面\TKUIofoCenterClient\uiFile\EditShiftDialog.ui'
#
...
class Ui_EditShiftDialog(object):
    def setupUi(self, EditShiftDialog):
        EditShiftDialog.setObjectName("EditShiftDialog")
        EditShiftDialog.setWindowFlags(Qt.CustomizeWindowHint)
        EditShiftDialog.resize(1000, 450)
        EditShiftDialog.setAutoFillBackground(False)
        EditShiftDialog.setStyleSheet("QDialog{background-color:white;}")

        self.retranslateUi(EditShiftDialog)
        QMetaObject.connectSlotsByName(EditShiftDialog)

        self.setupMainLayout(EditShiftDialog)
        self.setupDialogNav()
        self.setupCenterialArea()
        self.setupContentArea()
        self.setupNavArea()

    def retranslateUi(self, EditShiftDialog):
        _translate = QCoreApplication.translate
        EditShiftDialog.setWindowTitle(_translate("EditShiftDialog", "班別編輯"))
        EditShiftDialog.setWindowIcon(QIcon(SvgHelper.getQPixmapFromBytes(logoIcon, QSize(512, 512))))


    def setupMainLayout(self, EditShiftDialog):
        self.mainLayout = QVBoxLayout()
        self.mainLayout.setContentsMargins(0,0,0,0)
        EditShiftDialog.setLayout(self.mainLayout)
    ...
    def setupContentArea(self):
        ...
        self.listArea.setHeaderLabels(["班別名稱", "起始時間", "結束時間","工作時數","給付時數"])
